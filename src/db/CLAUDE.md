...
deckt Profile/Nodes/Edges/Merge, Communities (Per-Lens-CRUD/Members/Cascades und den
`(lens_id, members_key)`-Summary-Cache in `tests/communities.rs`, plus NULL-Reset bei
